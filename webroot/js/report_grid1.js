...
var ds = new Ext.data.Store({	
	...
	var aa = 0;
	var strListVal =listVal;
        var dataID=[];
        for(var i=0; i<strListVal.length; i++) {
		           dataID.push(parseInt(strListVal[i]));
	   }
	   ...
	   var checkBox = new Ext.grid.CheckboxSelectionModel({
		...
		renderer: function(v, p, record){
			...
			//if(strListVal[i] == 1) {return '<div class="x-grid3-row-checker">&#160;</div>';i++;} else {alert('b');aa++;}
