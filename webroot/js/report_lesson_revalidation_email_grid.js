...
function delete_remidial(id){
		...
		$.ajax({
			  type: "POST",
			  url: path+"Lessons/remidial_email_delete/",
			  data:"id="+id,
			  success: function(res)
			  {
							
				if(res=='ok'){
				     document.location=path+'Lessons/lesson_email_list/'+report_val;
				   }
...
function view_remedial(id,leid){
	jQuery.fancybox({
			...
			'transitionIn'		: 'fade',
			'transitionOut'		: 'fade',
			'href'			:  path+"Lessons/lesson_email_view/"+id+"/"+leid,
...
var ds = new Ext.data.Store({	
        proxy: new Ext.data.HttpProxy({url: AdminListPage+'Lessons/get_all_lesson_email_list/'+report_id}),  //note that I used host in the url
