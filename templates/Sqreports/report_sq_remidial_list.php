 ...
 <section>
           ...
           <script language="javascript" type="text/javascript">
              ...
              function redirect_page(){
                 ...
                 document.location=path+"Sqreports/add_sq_remidial/<?php echo base64_encode($id); ?>/";  		
           ...
           <h2>SQ Report(Remedial-<?php echo $report_number; ?>) List</h2>
           <?php if($is_add==1){ ?>
       ...
       <div id="grid-paging" ><?php echo $this->Html->script('report_sq_remidial_grid'); ?></div>
 </section>
