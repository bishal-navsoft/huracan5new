  ...
  ?>
   ...
   function immediate_cause_detail(){
	...
	echo $this->Form->create(null, [
		'url' => ['controller' => 'Sqreports', 'action' => 'addReportInvestigationData'], // adjust action if different
	...
	echo $this->Form->control('investigation_id', [
		'type' => 'hidden',
		'id' => 'investigation_id',
		'value' => $edit_investigation_id ?? null,
		'label' => false
	]);
