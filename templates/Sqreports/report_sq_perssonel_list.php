 ...
 <section>
           ...
           <script language="javascript" type="text/javascript">
              ...
              function redirect_page(){
                 ...
                 document.location=path+"Sqreports/add_sq_report_personal/<?php echo base64_encode($id); ?>/";  		
                
              }
              
            </script>
         <div class="topadmin_heading clearfix">
           <h2>SQ Report(Personnel-<?php echo $report_number; ?>) List</h2>
         <?php if($is_add==1){ ?>
                <input type="button" name="button" value="Add Personnel" onclick="redirect_page();" class="buttonadmin fright" />
         <?php } ?>
       </div>
       <div id="grid-paging" ><?php echo $this->Html->script('report_sq_personel_grid'); ?></div>
 </section>
