...
var damage = "<?php echo __('Damage');?>";
var comment  = "<?php echo __('Comment');?>";
var remedial  = "<?php echo __('Remedial');?>"; 
var remidial_closer_summary  = "<?php echo __('Remedial');?>";
 ...
 <section>
           ...
           <script language="javascript" type="text/javascript">
              ...
              function redirect_page(){
                 var path = "<?php echo $this->webroot;?>";
                 document.location=path+"Sqreports/add_sq_investigation_data_analysis/<?php echo base64_encode($report_id); ?>/";  		
                
              }
              
            </script>
           <div class="topadmin_heading clearfix">
                      <h2>SQ Report(Data Analysis- <?php echo $report_number; ?>) List</h2>
                      <?php if($is_add==1){ ?>
                             <input type="button" name="button" value="Add Incident Investigation" onclick="redirect_page();" class="buttonadmin fright" />
                      <?php } ?>
           </div>
 
      <div id="grid-paging" ><?php echo $this->Html->script('report_sq_incident_investigation_grid'); ?></div>
 </section>
