...
var incidentseverity_type  = "<?php echo __('Incident Severity');?>";
var sqdamage_type  = "<?php echo __('Damage Category');?>";
var loss_time  = "<?php echo __('Lost time');?>";
var incident_time  = "<?php echo __('Incident Time');?>";
var incident_date  = "<?php echo __('Incident Date');?>";
var affected_service  = "<?php echo __('Affected Service');?>";
var incident_time = "<?php echo __('Time of incident:');?>";
...
<?php echo $this->Element('left_menu'); ?>
 ...
 <section>
          <?php   echo $this->Element('sqtab');    ?>
           ...
           <script language="javascript" type="text/javascript">
              ...
              function redirect_page(){
                 ...
                 document.location=path+"Sqreports/add_sq_incident/<?php echo base64_encode($id); ?>/";  		
   ...
   <div class="topadmin_heading clearfix">
           <h2>SQ Report(Incident-<?php echo $report_number; ?>) List</h2>
         <?php if($is_add==1){ ?>
                <input type="button" name="button" value="Add Incident" onclick="redirect_page();" class="buttonadmin fright" />
         <?php } ?>
  </div>
    
 <div id="grid-paging" ><?php echo $this->Html->script('sq_incident_report_grid'); ?></div>
