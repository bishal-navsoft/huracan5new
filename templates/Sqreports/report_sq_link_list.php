...
function add_sq_link()
                   ...
                   $.ajax({
                              ...
                              success: function(res)
                              {
                                ...
                                if(res=='ok'){
                                       ...
                                       document.location='<?php echo $this->webroot; ?>Sqreports/report_sq_link_list/<?php echo $report_id_val; ?>/<?php echo base64_encode('all'); ?>';
                                 }else if(res=='avl'){
  ...
  function passLinkType(){
      ...
      document.location='<?php echo $this->webroot; ?>Sqreports/report_sq_link_list/<?php echo $report_id_val; ?>/'+'/'+Base64.encode(report_type);
...
<div class="topadmin_heading clearfix">
 <?php if($is_add==1){ ?>
<h2>Sq Report(<?php echo $report_number; ?>) Link List</h2>
<?php
...
<div id="grid-paging" ><?php  echo $this->Html->script('sq_link_grid'); ?></div>
</section>
