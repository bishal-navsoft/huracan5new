...
function add_sq_welldata()
{   
	      
	    var report_id ='<?php echo $report_id;?>';
            var dataStr = $("#add_sq_well_form").serialize();
	    ...
	    document.getElementById('loader').innerHTML='<img src="<?php echo $this->webroot; ?>img/loader.gif" />';	
              $.ajax({
			  type: "POST",
			  url: rootpath+"Sqreports/welldataprocess/",
...
<?php echo $this->Element('left_menu'); ?>
 ...
 <?php
  ...
  ?>
    ...
    <?php  
    echo $this->Form->create('add_sq_well_form', array('controller' => 'Sqreports','name'=>"add_sq_well_form", 'id'=>"add_sq_well_form", 'method'=>'post','class'=>'adminform'));
...
<span id="loader" style="float:left;font-size: 13px;"></span><input type="button" name="save" id="save" class="buttonsave" onclick="add_sq_welldata();" value="<?php echo $button; ?>" />
</div>
