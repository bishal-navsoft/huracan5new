...
var  listVal='<?php echo implode(",",$_SESSION['sqIdBoolen']);  ?>';
function pageRedrection(){
                
               document.location=path+"Sqreports/add_sq_report_main/";  		
