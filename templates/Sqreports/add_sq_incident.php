...
<?php
	echo $this->Form->create(null, [
		'url'   => ['controller' => 'Reports', 'action' => 'addReportIncident'], // adjust if needed
...
<?php
    for ($i = 0; $i <= 23; $i++) {for ($j = 0; $j <= 59; $j += 15) {
...
<div class="clearflds"></div>
<label><?PHP echo __("Date of Incident:"); ?></label><?PHP echo $this->Form->input('date_incident', ['type' => 'text', 'id' => 'date_incident', 'name' => 'date_incident', 'readonly' => 'readonly', 'value' => $date_incident, 'label' => false, "onclick" => "displayDatePicker('date_incident',this);", 'div' => false]); ?><span class="textcmpul" id="date_incident_error"></span>
...
<label><?PHP echo __("Incident Summary:"); ?></label><?PHP echo $this->Form->input('incident_summary', ['type' => 'textarea', 'id' => 'incident_summary', 'name' => 'incident_summary', 'value' => $incident_summary, 'label' => false, 'div' => false, "onkeyup" => "check_character();"]); ?>
<div class="clearflds"></div>
<label>&nbsp;</label><lable style="font-size: 11px;">Only 100 characters allow for summary</lable>
<div class="clearflds"></div>
<label><?PHP echo __("Details:"); ?></label><?PHP echo $this->Form->input('detail', ['type' => 'textarea', 'id' => 'detail', 'name' => 'detail', 'value' => $detail, 'label' => false, 'div' => false]); ?>
<div class="clearflds"></div>
