...
function passLinkType(){
      ...
      document.location='<?php echo $this->webroot; ?>Jhas/report_jha_link_list/<?php echo $report_id_val; ?>/'+'/'+Base64.encode(report_type);
	    
	    
	    
}

function add_jha_link()
    {
                   ...
                   $.ajax({
                              ...
                              success: function(res)
                              {
                                ...
                                if(res=='ok'){
                                       ...
                                       document.location='<?php echo $this->webroot; ?>Jhas/report_jha_link_list/<?php echo $report_id_val; ?>/<?php echo base64_encode('all'); ?>';
                                 }else if(res=='avl'){
...
<?php echo $this->Element('left_menu'); ?>
 ...
 <section>
 <?php  echo $this->Element('jhatab'); ?>
<div class="topadmin_heading clearfix">
 <?php if($is_add==1){ ?>
<h2>Job Hazard Analysis Report(<?php echo $report_number; ?>) Link List</h2>
<?php
		                 ...
		                 <?php   echo $this->Element("report_dropdown"); ?>
                           ...
                           <?php   echo $this->Element("link_list"); ?>
                             ...
                             <td width="10%" align="right" valign="middle" >
                               <?php if($is_add==1){ ?>
                                <input type="button" name="button" value="Add" class="buttonsave" onclick="add_jha_link();" />
                                <?php } ?>
                                </td>
                           </tr>
                         </table>
...
<div id="grid-paging" ><?php  echo $this->Html->script('jha_link_grid'); ?></div>
</section>
