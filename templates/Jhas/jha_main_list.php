...
function pageRedrection(){
               ...
               document.location=path+"Jhas/add_jha_report_main/";  		
...
<h2>Job Hazard Analysis Report(Main) List</h2>
<input type="button" name="button" value="Add Main" onclick="pageRedrection();" class="buttonadmin fright" />
</div>
    
 <div id="grid-paging" ><?php  echo $this->Html->script('report_jha_grid'); ?></div>
 </section>