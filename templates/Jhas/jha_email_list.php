...
<?php echo $this->Element('left_menu'); ?>
 ...
 <section>
     ...
     <script language="javascript" type="text/javascript">
	      ...
	      <h2>Job Hazard Analysis(Revalidation Email-<?php echo $report_number; ?>) List</h2>	      
          
          </div>  
            

       <div id="grid-paging" ><?php echo $this->Html->script('report_jha_revalidation_email_grid'); ?></div>
 </section>
