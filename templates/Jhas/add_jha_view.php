                ...
                <tr><td align="left" width="22%" valign="middle" class="label">Description</td><td align="left" width="78%" valign="middle" class="label">File Name</td></tr>    
				  ...
				  <?php  
				    ...
				    $file_type_array = array ('pdf', 'xlsx', 'xls','doc','xlsm');
		                    $filetype=explode('.',$reportdetail[0]['JhaAttachment'][$k]['file_name']);
				    if(in_array($filetype[1],$file_type_array)){
					    $fileSRC='<a href='.$this->webroot.'img/file_upload/'.$reportdetail[0]['JhaAttachment'][$k]['file_name'].'>'.$reportdetail[0]['JhaAttachment'][$k]['file_name'].'</a>';
				    
				    }else{
					  
					  
					   $fileSRC='<a href='.$this->webroot.'resize.php?src=img/file_upload/'.$reportdetail[0]['JhaAttachment'][$k]['file_name'].'&w=300&h=300 target="_blank">'.$reportdetail[0]['JhaAttachment'][$k]['file_name'].'</a>';
