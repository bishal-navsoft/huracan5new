 ...
 var docprint=window.open("","",disp_setting); 
  ...
  <div class="view_sub_contentwrap">
     <table width="100%" border="0" cellspacing="1" cellpadding="0" class="reporttableHeader" >
      <tr>
	    <td colspan="2" rowspan="2" width="49%" style="margin-left: 20px;"><img src="<?php echo $this->webroot; ?>images/huracan_logo.png" alt="Huracan" title="Huracan"></td> <td colspan="2" rowspan="2" width="49%" style="padding-bottom:20px;color: #75309F;font-size: 24px;font-weight:600">Job Hazard Analysis Report
           </td>
      </tr>
    <table width="100%" border="0" cellspacing="1" cellpadding="0" class="reporttableHeader">
                <tr>
			      ...
			      <td width="28%" align="left" valign="middle" class="titles" style="color:red;border-right: 2px solid #C9A5E4;"><?php echo $reportdetail[0]['JhaMain']['report_no']; ?>&nbsp;<span id="print_button_area"><input type="button" name="save" id="print_button" class="buttonview" onclick="Clickheretoprint();"  value="Print" /></span></td>
		    </tr>
