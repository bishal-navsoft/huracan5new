...
function pageRedrection(){
               ...
               document.location=path+"Suggestions/add_suggestion_report_main/";  		
...
<h2>Suggestion(Main) List</h2>
<input type="button" name="button" value="Add Main" onclick="pageRedrection();" class="buttonadmin fright" />
</div>
    
 <div id="grid-paging" ><?php  echo $this->Html->script('report_suggestion_grid'); ?></div>
 </section>