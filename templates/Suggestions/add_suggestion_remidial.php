...
<?php 
    echo $this->Form->create(null, [
      'url' => ['controller' => 'Reports', 'action' => 'addReportRemidial'], // update action name if needed
      'method' => 'post',
...
<input type="button" name="save" id="save" class="buttonsave" onclick="add_report_remidial('<?php echo $this->webroot; ?>Suggestions/remidialprocess/');" value="<?php echo $button; ?>" />
</span>
</div>
