 ...
 <section>
     ...
     <script language="javascript" type="text/javascript">
		...
		$("#main").removeClass("selectedtab");
           ...
           <h2>Suggestion Report(Remedial Action Email-<?php echo $report_number; ?>) List</h2>
           
          </div>  
            

       <div id="grid-paging" ><?php echo $this->Html->script('report_suggestion_remidial_email_grid'); ?></div>
 </section>
