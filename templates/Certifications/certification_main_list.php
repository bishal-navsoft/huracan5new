...
var triner_name  = "<?php echo __('Trainer');?>";
var certificate_type= "<?php echo __('Cert Name');?>";
var cert_date_val = "<?php echo __('Cert Date');?>";
var valid_date = "<?php echo __('Validity (Days)');?>"; 
var expire_date_val = "<?php echo __('Expiry Date');?>";
var certificate_user = "<?php echo __('Certificate  User');?>";
...
<?php echo $this->Element('left_menu'); ?>
 ...
 <section>
            <?php   echo $this->Element('certificationtab');    ?>
           ...
           <script language="javascript" type="text/javascript">
              ...
              function redirect_page(){
                 ...
                 document.location=path+"Certifications/add_certification_main";  		
           ...
           <h2>Certification Report List</h2>
           <?php if($is_add==1){ ?>
                 <input type="button" name="button" value="Add Certificate" onclick="redirect_page();" class="buttonadmin fright" />
           <?php } ?>
          </div>
            
            

       <div id="grid-paging" ><?php  echo $this->Html->script('certification_grid'); ?></div>
 </section>
