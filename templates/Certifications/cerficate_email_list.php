...
var status_value= "<?php echo __('Status');?>";
...
var cert_type = "<?php echo __('Certification Name');?>";  
var crt_date = "<?php echo __('Create Date');?>";
var send_person = "<?php echo __('Send Person');?>";
...
<?php echo $this->Element('left_menu'); ?>
 ...
 <section>
           ...
           <h2>Certification Email List</h2>
           
          </div>  
            

       <div id="grid-paging" ><?php echo $this->Html->script('report_certificationemail_email_grid'); ?></div>
 </section>
