 ...
 <?php echo $this->Element('left_menu'); ?>
	    ...
	    $(document).ready(function() {
		 ...
		 $("#print").removeClass("selectedtab");
              ...
              function pageRedrection(){
                 ...
                 document.location=path+"Certifications/add_certificate_attachment";  		
	    ...
	    <section>
	     <?php echo $this->Element('certificationtab'); ?>
		  ...
		  <h2>Certification Report Attachment  List</h2>
		  <?php if($is_add==1){ ?>
		     <input type="button" name="button" value="Add Attachment" onclick="pageRedrection();" class="buttonadmin fright" />
		  <?php } ?>   
		  </div>
    
                  <div id="grid-paging"><?php echo $this->Html->script('certification_attachment_report_grid'); ?></div>
            </section>
