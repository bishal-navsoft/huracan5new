...
var pagelmt = "<?php if($limit=='all'){ echo '50';}else{ echo $limit; }?>";
...
function passLinkType(){
      ...
      document.location='<?php echo $this->webroot; ?>Reports/report_hsse_link_list/<?php echo $report_id_val; ?>/'+'/'+Base64.encode(report_type);
                   ...
                   $.ajax({
                              ...
                              success: function(res)
                              {
                                ...
                                if(res=='ok'){
                                       ...
                                       document.location='<?php echo $this->webroot; ?>Reports/report_hsse_link_list/<?php echo $report_id_val; ?>/<?php echo base64_encode('all'); ?>';
                                 }else if(res=='avl'){
...
<div class="topadmin_heading clearfix">
 <?php if($is_add==1){ ?>
<h2>Hsse Report(<?php echo $report_number; ?>) Link List</h2>
<?php
...
<div class="looptable_panel">
		                 ...
		                 <?php   echo $this->Element("report_dropdown"); ?>
                           ...
                           <?php   echo $this->Element("link_list"); ?>
                             ...
                             <td width="10%" align="right" valign="middle" >
                               <?php if($is_add==1){ ?>
                                <input type="button" name="button" value="Add" class="buttonsave" onclick="add_hsse_link();" />
                                <?php } ?>
                                </td>
                           </tr>
                         </table>
 ...
 <div id="ajax_sort"><div id="grid-paging"><?php  echo $this->Html->script('hsse_link_grid'); ?></div></div>
</section>
