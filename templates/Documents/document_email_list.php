...
var createby_person= "<?php echo __('Create By');?>";

var email_date = "<?php echo __('Send Date');?>";
var email= "<?php echo __('Email');?>"; 
var remedial_no = "<?php echo __('Remedial No');?>";
var revalidate_date_val = "<?php echo __('Revalidation Date');?>";
var create_on_val = "<?php echo __('Create On');?>";
...
<?php echo $this->Element('left_menu'); ?>
 ...
 <section>
     ...
     <script language="javascript" type="text/javascript">
	       ...
	       $("#revalidation").addClass("selectedtab");
           ...
           <h2>Document Report(Revalidation Email-<?php echo $report_number; ?>) List</h2>
           
          </div>  
            

       <div id="grid-paging" ><?php echo $this->Html->script('report_document_revalidation_email_grid'); ?></div>
 </section>
