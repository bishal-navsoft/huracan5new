 ...
 var docprint=window.open("","",disp_setting); 
  ...
  docprint.document.write('<head><meta http-equiv="Content-Type" content="text/html; charset=utf-8" /><title></title></head>');
   ...
   <div class="view_sub_contentwrap">
      ...
      <tr>
	<td colspan="2" rowspan="2" width="49%" style="margin-left: 20px;"><img src="<?php echo $this->webroot; ?>images/huracan_logo.png" alt="Huracan" title="Huracan"></td> <td colspan="2" rowspan="2" width="49%" style="padding-bottom:20px;color: #75309F;font-size: 24px;font-weight:600">Document
</td>
      </tr>
  </table> 
	  ...
	  <table width="100%" border="0" cellspacing="1" cellpadding="0" class="reporttableHeader">
                <tr>
			      ...
			      <td width="28%" align="left" valign="middle" class="titles" style="color:red;border-right: 2px solid #C9A5E4;"><?php echo $reportdetail[0]['DocumentMain']['report_no']; ?>&nbsp;<span id="print_button_area"><input type="button" name="save" id="print_button" class="buttonview" onclick="Clickheretoprint();"  value="Print" /></span></td>
		    </tr>
	 ...
	 if(isset($reportdetail[0]['DocumentAttachment'][0])){?>
           ...
           <table width="100%" border="0" cellspacing="1" cellpadding="0" class="viewreporttable">
                ...
                <tr><td align="left" width="22%" valign="middle" class="label">Description</td><td align="left" width="78%" valign="middle" class="label">File Name</td></tr>    
				  ...
				  <td align="left"  width="78%" valign="middle"><a href="<?php echo $this->webroot; ?>img/file_upload/<?php echo $reportdetail[0]['DocumentAttachment'][$k]['file_name']; ?>" ><?php echo $reportdetail[0]['DocumentAttachment'][$k]['file_name'];?></a></td>
