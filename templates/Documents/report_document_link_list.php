...
function passLinkType(){
      ...
      document.location='<?php echo $this->webroot; ?>Documents/report_document_link_list/<?php echo $report_id_val; ?>/'+'/'+Base64.encode(report_type);
	    
	    
	    
}

function add_document_link()
    {
           	...
           	if(report_data!=0){   
                ...
                document.getElementById('res_msg').innerHTML='<img src="<?php echo $this->webroot; ?>img/loader.gif" />';	
                   ...
                   $.ajax({
                              type: "POST",
                              url: rootpath+"Documents/linkrocess/",
                              ...
                              success: function(res)
                              {
                                ...
                                if(res=='ok'){
                                       ...
                                       document.location='<?php echo $this->webroot; ?>Documents/report_document_link_list/<?php echo $report_id_val; ?>/<?php echo base64_encode('all'); ?>';
                                 }else if(res=='avl'){
...
<?php echo $this->Element('left_menu'); ?>
 ...
 <section>
 <?php   echo $this->Element('documentationtab');    ?>
<div class="topadmin_heading clearfix">
 <?php if($is_add==1){ ?>
<h2>Document Report(<?php echo $report_number; ?>) Link List</h2>
<?php
		                 ...
		                 <?php   echo $this->Element("report_dropdown"); ?>
                           ...
                           <?php   echo $this->Element("link_list"); ?>
                             ...
                             <td width="10%" align="right" valign="middle" >
                               <?php if($is_add==1){ ?>
                                <input type="button" name="button" value="Add" class="buttonsave" onclick="add_document_link();" />
                                <?php } ?>
                                </td>
                           </tr>
                         </table>
...
<div id="grid-paging" ><?php  echo $this->Html->script('document_link_grid'); ?></div>
</section>
