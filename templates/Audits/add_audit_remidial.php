...
<?php echo $this->Element('left_menu'); ?>
 ...
 <?php
     ...
     <script language="javascript" type="text/javascript">
		...
		$("#action").addClass("selectedtab");
		$("#attachments").removeClass("selectedtab");
		$("#remidialemail").removeClass("selectedtab");
...
<?php 
    echo $this->Form->create('add_report_remidial_form', array('controller' => 'Audits','name'=>"add_report_remidial_form", 'id'=>"add_report_remidial_form", 'method'=>'post','class'=>'adminform'));
...
<input type="button" name="save" id="save" class="buttonsave" onclick="add_report_remidial('<?php echo $this->webroot; ?>Audits/remidialprocess/');" value="<?php echo $button; ?>" />
</span>
</div>
