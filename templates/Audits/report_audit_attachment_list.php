...
<?php echo $this->Element('left_menu'); ?>
	    ...
	    $(document).ready(function() {
		    ...
		    $("#print").removeClass("selectedtab");
              ...
              function pageRedrection(){
                 ...
                 document.location=path+"Audits/add_audit_attachment/<?php echo base64_encode($id); ?>/";  		
	    ...
	    <section>
		  ...
		  <h2>Audit Report(Attachment-<?php echo $report_number; ?>) List</h2>
		  <?php if($is_add==1){ ?>
		     <input type="button" name="button" value="Add Attachment" onclick="pageRedrection();" class="buttonadmin fright" />
		  <?php } ?>   
		  </div>
    
                  <div id="grid-paging"><?php echo $this->Html->script('audit_attachment_report_grid'); ?></div>
          </section>
