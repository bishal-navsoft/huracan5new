            ...
            <td align="left" valign="top" bgcolor="#FFFFFF"><table width="579" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr>
                <td align="left" valign="top" style="font-family: Tahoma, Geneva, sans-serif; font-size:13px; color:#333;"><p>Hello &nbsp;&nbsp;<strong><?php echo ucwords($fullname); ?>,</strong></p><br/>
                  ...
                  <p>Report Type:&nbsp; Audit / Inspection Report</p></br>
                  <p>Your Remedial Action No:&nbsp;<?php echo $remidialData[0]['AuditRemidial']['remedial_no'];?></p></br>
                  <p>Summary: &nbsp;<?php echo $remidialData[0]['AuditRemidial']['remidial_summery'];?></p></br>
                  
                  <p>Closure Date:&nbsp;<?php if($remidialData[0]['AuditRemidial']['remidial_closure_date']!='0000-00-00'){ echo $remidialData[0]['SqRemidial']['remidial_closure_date']; }?></p></br>
                 </td>
                </tr>
              <tr>
                <td style="font-size:0;"><img src="<?php echo $this->webroot ;?>images/spacer.png" height="10" width="1" /></td>
