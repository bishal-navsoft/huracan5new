...
var  listVal='<?php echo implode(",",$_SESSION['auditIdBoolen']);  ?>';
function pageRedrection(){
                
               document.location=path+"Audits/audit_report_main/";  		
...
<h2>Audit Report(Main) List</h2>
 <?php if($is_add==1){ ?>
<input type="button" name="button" value="Add Main" onclick="pageRedrection();" class="buttonadmin fright" />
<?php } ?>
</div>
 <div id="grid-paging" ><?php echo $this->Html->script('audit_report_grid'); ?></div>
 </section>