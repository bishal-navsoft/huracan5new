...
function passLinkType(){
      ...
      document.location='<?php echo $this->webroot; ?>Audits/report_audit_link_list/<?php echo $report_id_val; ?>/'+'/'+Base64.encode(report_type);
	    
	    
	    
}

function add_audit_link()
    {
                   ...
                   $.ajax({
                              ...
                              success: function(res)
                              {
                                ...
                                if(res=='ok'){
                                       ...
                                       document.location='<?php echo $this->webroot; ?>Audits/report_audit_link_list/<?php echo $report_id_val; ?>/<?php echo base64_encode('all'); ?>';
                                 }else if(res=='avl'){
		                 ...
		                 <?php   echo $this->Element("report_dropdown"); ?>
                           ...
                           <?php   echo $this->Element("link_list"); ?>
                             ...
                             <td width="10%" align="right" valign="middle" >
                               <?php if($is_add==1){ ?>
                                <input type="button" name="button" value="Add" class="buttonsave" onclick="add_audit_link();" />
                                <?php } ?>
                                </td>
                           </tr>
                         </table>
