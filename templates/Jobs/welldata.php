 ...
 <?php
  ...
  ?>
    ...
    echo $this->Form->create(null, [
        'url' => ['controller' => 'Jobs', 'action' => 'addJobWell'],
        'name' => 'add_job_well_form',
        'id' => 'add_job_well_form',
        'method' => 'post',
        'class' => 'adminform'
    ]);
...
<label><?PHP echo __("Rig:");?></label><?PHP echo $this->Form->input('rig', array('type'=>'text', 'id'=>'rig','value'=>$rig,'name'=>'rig','label' => false,'maxlength'=>30,'div' => false)); ?>
