...
<?php echo $this->Element('left_menu'); ?>
 ...
 <section>
		...
		$("#main").removeClass("selectedtab");
	        ...
	        $("#view").removeClass("selectedtab");
              ...
              function redirect_page(){
                 ...
                 document.location=path+"Jobs/add_job_remidial/<?php echo base64_encode($id); ?>/";  		
           ...
           <h2>Job Report(Remedial-<?php echo $report_number; ?>) List</h2>
           <?php if($is_add==1){ ?>
       ...
       <div id="grid-paging" ><?php echo $this->Html->script('report_job_remidial_grid'); ?></div>
 </section>
