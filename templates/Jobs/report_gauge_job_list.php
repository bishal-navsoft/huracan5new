...
var ysplitter  = "<?php echo __('Y-splitre');?>";
var gauge_sn = "<?php echo __('Gauge SN#');?>";
var tec_cable  = "<?php echo __('Tec Cable');?>";
var gauge_set_depth  = "<?php echo __('Gauge Set Depth');?>";
var manufacture= "<?php echo __('Manufacture');?>";
var temp_range= "<?php echo __('Temp Range');?>";
var press_range = "<?php echo __('Pres Range');?>";
var gauge_type = "<?php echo __('Gauge Type');?>"; 
var comments = "<?php echo __('Comments');?>";
var gauge_sn = "<?php echo __('Gauge Sn');?>"; 
var who_connector = "<?php echo __('WHO Connector');?>";
var sau = "<?php echo __('Sau');?>";
var gauge_type = "<?php echo __('Gauge Type');?>"; 
var gauge_no = "<?php echo __('Gauge No');?>";
...
<?php echo $this->Element('left_menu'); ?>
 ...
 <section>
           ...
           <script language="javascript" type="text/javascript">
	         ...
	         $("#gauge_job_data").addClass("selectedtab");
	         ...
	         $("#view").removeClass("selectedtab");
              ...
              function redirect_page(){
                 var path='<?php echo $this->webroot ?>';
                 document.location=path+"Jobs/add_gauge_job_data/<?php echo base64_encode($id); ?>/";  		
           ...
           <h2>Job Report(Gauge Job Data-<?php echo $report_number; ?>) List</h2>
           <?php if($is_add==1){ ?>
                 <input type="button" name="button" value="Add Gauge Job Data" onclick="redirect_page();" class="buttonadmin fright" />
           <?php } ?>
          </div>
            
            

       <div id="grid-paging" ><?php echo $this->Html->script('report_job_gauge_grid'); ?></div>
 </section>
