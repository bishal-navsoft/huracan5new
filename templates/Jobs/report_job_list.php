...
var  listVal='<?php echo implode(",",$_SESSION['jobIdBoolen']);  ?>';
function pageRedrection(){
                
               document.location=path+"Jobs/add_job_report_main/";  		
