...
var admins = "<?php echo __('Journey Management');?>";
var name = "<?php echo __('Trip number');?>";
var name_tag = "<?php echo __('[Trip number]');?>";
var created = "<?php echo __('Created Date');?>";
var trip_number  = "<?php echo __('Trip number');?>";

var trip_date  = "<?php echo __('Trip Date');?>";
var  closure = "<?php echo __('Closer Date');?>";
var createdby  = "<?php echo __('Created By');?>";
var summary  = "<?php echo __('Summary');?>"; 
var departure_time  = "<?php echo __('Departure Time');?>";
...
var  listVal='<?php echo implode(",",$_SESSION['jnIdBollen']);  ?>';
function pageRedrection(){
                
               document.location=path+"Jrns/add_jn_report_main/";  		
...
<h2>Journey Report(Main) List</h2>
 <?php if($is_add==1){ ?>
<input type="button" name="button" value="Add Main" onclick="pageRedrection();" class="buttonadmin fright" />
<?php } ?>
</div>
    
 <div id="grid-paging" ><?php echo $this->Html->script('report_jn_grid');  ?></div>
 </section>