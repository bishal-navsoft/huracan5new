...
<?php echo $this->Element('left_menu'); ?>
           ...
           <script language="javascript" type="text/javascript">
              ...
              function pageRedrection(){
                 ...
                 document.location=path+"Jrns/add_jn_attachment/<?php echo base64_encode($id); ?>/";  		
	    ...
	    <section>
		  ...
		  <h2>Journey Report(Attachment-<?php echo $report_number; ?>) List</h2>
		  <?php if($is_add==1){ ?>
		     <input type="button" name="button" value="Add Attachment" onclick="pageRedrection();" class="buttonadmin fright" />
		  <?php } ?>   
		  </div>
    
                  <div id="grid-paging"><?php echo $this->Html->script('jn_attachment_report_grid'); ?></div>
          </section>
