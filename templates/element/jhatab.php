...
<script  language="javascript" type="text/javascript">
	...
	jQuery.fancybox({
			...
			'transitionIn'		: 'fade',
			'transitionOut'		: 'fade',
			'href'				:"<?php echo $this->webroot; ?>Jhas/print_view/"+id,
    ...
    function change_dirction(tabval){
          switch(tabval){
            case'main':
            document.location="<?php echo $this->webroot; ?>Jhas/add_jha_report_main/<?php echo $this->params['pass'][0];?>";
            break;
             case'revalidation':
            document.location="<?php echo $this->webroot; ?>Jhas/jha_email_list/<?php echo $this->params['pass'][0]; ?>";
            break;
            case'attachment':
            document.location="<?php echo $this->webroot; ?>Jhas/report_jha_attachment_list/<?php echo $this->params['pass'][0]; ?>"; 
            break;
            case'link':
            document.location="<?php echo $this->webroot; ?>Jhas/report_jha_link_list/<?php echo $this->params['pass'][0]; ?>/<?php echo base64_encode('all'); ?>";
            break;
            case'view':
            document.location="<?php echo $this->webroot; ?>Jhas/add_jha_view/<?php echo $this->params['pass'][0]; ?>";  
            break;
