...
<script  language="javascript" type="text/javascript">
  function open_lightbox(id)
	...
	jQuery.fancybox({
			...
			'transitionIn'		: 'fade',
			'transitionOut'		: 'fade',
			'href'				:"<?php echo $this->webroot; ?>Documents/print_view/"+id,
    ...
    function change_dirction(tabval){
          switch(tabval){
            case'main':
            document.location="<?php echo $this->webroot; ?>Documents/document_main_list/<?php echo $this->params['pass'][0]; ?>";    
            break;
	    case'revalidation':
            document.location="<?php echo $this->webroot; ?>Documents/document_email_list/<?php echo $this->params['pass'][0]; ?>";
            break;
            case'attachment':
            document.location="<?php echo $this->webroot; ?>Documents/report_doucument_attachment_list/<?php echo $this->params['pass'][0]; ?>";
            break;
	    case'link':
            document.location="<?php echo $this->webroot; ?>Documents/report_document_link_list/<?php echo $this->params['pass'][0]; ?>/<?php echo base64_encode('all'); ?>";
            break;
            case'view':
            document.location="<?php echo $this->webroot; ?>Documents/add_dcreport_view/<?php echo $this->params['pass'][0]; ?>";  
            break;
         }
    }
