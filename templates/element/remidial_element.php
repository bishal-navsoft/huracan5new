	    	...
	    	onSelect: function(dateText, inst) {
				...
				if(date!=''){
					$.ajax({
					    ...
					    data: {
							remidial_create: remidial_create,
							remidial_priority: remidial_priority,
					    ...
					    success: function(res) {
							...
							if (data.status === 'success') {
								...
								// ✅ Only set the date value — not the label text
								document.getElementById('reminder_date_holder').textContent = data.calculated_date;
								document.getElementById('remidial_reminder_data').value = data.calculated_date;

								document.getElementById('remidial_closure_holder').textContent = data.calculated_date;
								document.getElementById('remidial_closure_target').value = data.calculated_date;
							} else {
