...
<script  language="javascript" type="text/javascript">
	...
	jQuery.fancybox({
			...
			'transitionIn'		: 'fade',
			'transitionOut'		: 'fade',
			'href'				:"<?php echo $this->webroot; ?>Suggestions/print_view/"+id,
    ...
    function change_dirction(tabval){
          switch(tabval){
            ...
            break;
            case'remidialaction':
            document.location="<?php echo $this->webroot; ?>Suggestions/report_suggestion_remidial_list/<?php echo $this->params['pass'][0]; ?>";
            break;
            case'remidialemail':
             document.location="<?php echo $this->webroot; ?>Suggestions/report_suggestion_remedila_email_list/<?php echo $this->params['pass'][0]; ?>";
            break;
            case'attachment':
            document.location="<?php echo $this->webroot; ?>Suggestions/report_suggestion_attachment_list/<?php echo $this->params['pass'][0]; ?>"; 
            break;
            case'link':
            document.location="<?php echo $this->webroot; ?>Suggestions/report_suggestion_link_list/<?php echo $this->params['pass'][0]; ?>/<?php echo base64_encode('all'); ?>";
            break;
            case'view':
            document.location="<?php echo $this->webroot; ?>Suggestions/add_suggestion_view/<?php echo $this->params['pass'][0]; ?>";  
            break;
