...
<input style="display:none;" type="text"  id="priority_specific_date" readonly="readonly" name="return_depart_date" style="width:90px;" onclick="displayDatePicker('return_depart_date',this);"  ><i id="dateicon" style="display:none;" class="fa fa-calendar hasdatepicker"></i>
