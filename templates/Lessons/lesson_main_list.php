...
var services_name  = "<?php echo __('Service');?>";
...
var  listVal='<?php echo implode(",",$_SESSION['idLessonBoolen']);  ?>';
function pageRedrection(){
                
               document.location=path+"Lessons/add_lesson_report_main/";  		
...
<h2>Best Practice Lesson Report(Main) List</h2>
 <?php if($is_add==1){ ?>
<input type="button" name="button" value="Add Main" onclick="pageRedrection();" class="buttonadmin fright" />
<?php } ?>
</div>
    
 <div id="grid-paging" ><?php  echo $this->Html->script('report_lesson_grid'); ?></div>
 </section>