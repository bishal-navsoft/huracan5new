			  ...
			  success: function(res)
			  {
			   ...
			   var resval=res.split("~");
			      if(resval[0]=='fail'){
				   ...
				   document.getElementById('loader').innerHTML='<font color="green">Best Practice Lesson Main Added Successfully</font>';
				   document.location='<?php echo $this->webroot; ?>Lessons/add_lesson_report_main/'+resval[1];
				   
                             }else if(resval[0]=='update'){
				   document.getElementById('loader').innerHTML='<font color="green">Best Practice Lesson Main Updated Successfully</font>';
				   document.location='<?php echo $this->webroot; ?>Lessons/add_lesson_report_main/'+resval[1];
				  }
...
<?php echo $this->Element('left_menu'); ?>
 ...
 <?php
    ...
    echo $this->Form->create('add_lesson_main_form', array('controller' => 'Lessons','name'=>"add_lesson_main_form", 'id'=>"add_lesson_main_form", 'method'=>'post','class'=>'adminform'));
...
<label><?PHP echo __("Type:");?></label>
				   ...
				   <option value="<?php echo $lType[$i]['LessonType']['id'].'~'.$lType[$i]['LessonType']['type']; ?>" <?php if($l_type==$lType[$i]['LessonType']['id']){echo "selected";}else{} ?>><?php echo $lType[$i]['LessonType']['type']; ?></option>
				   <?php } ?>
			     </select>
<div class="clearflds"></div>		 
